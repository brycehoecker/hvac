/****************************************************************************
** $Id: VHelpWindow.cpp,v 1.2 2006/03/30 17:11:40 humensky Exp $
**
...
VHelpWindow::VHelpWindow( const QString& home_, const QString& _path,
      ...
      pathCombo( 0 )
{
    ...
    QIconSet icon_back( QPixmap("/usr/local/veritas/SP05/hvac/DataFiles/pixmaps/back.xpm") );
    QIconSet icon_forward( QPixmap("/usr/local/veritas/SP05/hvac/DataFiles/pixmaps/forward.xpm") );
    QIconSet icon_home( QPixmap("/usr/local/veritas/SP05/hvac/DataFiles/pixmaps/home.xpm") );
...
void VHelpWindow::setBackwardAvailable( bool b)
{
    menuBar()->setItemEnabled( backwardId, b);
}

void VHelpWindow::setForwardAvailable( bool b)
{
    menuBar()->setItemEnabled( forwardId, b);
}


void VHelpWindow::sourceChanged( const QString& url )
{
...
void VHelpWindow::about()
{
    QMessageBox::about( this, "Help Browser",
			"<p>A Help Browser for HVAC based on the QT example "
			" helpwindow.cpp</p>" );
}


void VHelpWindow::aboutQt()
{
    QMessageBox::aboutQt( this, "QBrowser" );
}

void VHelpWindow::openFile()
{
...
void VHelpWindow::newWindow()
{
    ( new VHelpWindow(browser->source(), "qbrowser") )->show();
}

void VHelpWindow::print()
{
...
void VHelpWindow::pathSelected( const QString &_path )
{
...
void VHelpWindow::readBookmarks()
{
...
void VHelpWindow::histChosen( int i )
{
    if ( mHistory.contains( i ) )
	browser->setSource( mHistory[ i ] );
}

void VHelpWindow::bookmChosen( int i )
{
    if ( mBookmarks.contains( i ) )
	browser->setSource( mBookmarks[ i ] );
}

void VHelpWindow::addBookmark()
{
