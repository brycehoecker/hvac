...
class VHVControl : public QCanvas {
 ...
 public:
  ...
  void scaleVoltages( float percent );
  void offsetVoltages( float voltage );
  void setAllVoltages( float voltage );
  void markDisabled( int brokenpixel );
  void unmarkDisabled( int brokenpixel );
  ...
  void pixelFeedbackReset( int ch );
  void globalFeedbackOn();
  void pixelFeedbackOn( int ch );
  void globalFeedbackOff();
  void pixelFeedbackOff( int ch );
  ...
  void pixelSetVReq( int chan, int voltage );
  float pixelGetVReq( int chan );
...
class VCamInfo  {
 ...
 private:
  ...
  QCanvasPolygon* fDisabledIcon;
  QCanvasText* fNoAutoLabel;
  QCanvasText* fSuppressedLabel;
  QCanvasText* fDisabledLabel;
/*   QCanvasText* fTemp; */
/*   QCanvasText* fHum; */
