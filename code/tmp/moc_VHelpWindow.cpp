/****************************************************************************
** VHelpWindow meta object code from reading C++ file 'VHelpWindow.h'
**
...
const char *VHelpWindow::className() const
{
    return "VHelpWindow";
}

QMetaObject *VHelpWindow::metaObj = 0;
static QMetaObjectCleanUp cleanUp_VHelpWindow( "VHelpWindow", &VHelpWindow::staticMetaObject );

#ifndef QT_NO_TRANSLATION
QString VHelpWindow::tr( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "VHelpWindow", s, c, QApplication::DefaultCodec );
    else
	return QString::fromLatin1( s );
}
#ifndef QT_NO_TRANSLATION_UTF8
QString VHelpWindow::trUtf8( const char *s, const char *c )
{
    if ( qApp )
	return qApp->translate( "VHelpWindow", s, c, QApplication::UnicodeUTF8 );
    else
...
QMetaObject* VHelpWindow::staticMetaObject()
{
    if ( metaObj )
	return metaObj;
	...
	0, 0 );
    cleanUp_VHelpWindow.setMetaObject( metaObj );
    return metaObj;
}

void* VHelpWindow::qt_cast( const char* clname )
{
    if ( !qstrcmp( clname, "VHelpWindow" ) )
	return this;
    return QMainWindow::qt_cast( clname );
}

bool VHelpWindow::qt_invoke( int _id, QUObject* _o )
{
...
bool VHelpWindow::qt_emit( int _id, QUObject* _o )
{
    return QMainWindow::qt_emit(_id,_o);
}
#ifndef QT_NO_PROPERTIES

bool VHelpWindow::qt_property( int id, int f, QVariant* v)
{
    return QMainWindow::qt_property( id, f, v);
}

bool VHelpWindow::qt_static_property( QObject* , int , int , QVariant* ){ return FALSE; }
#endif // QT_NO_PROPERTIES
